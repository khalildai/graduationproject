...
public class CavaliersNoteDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CavaliersNoteDeleteServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "admincavaliersforum.jsp";
		String sjk = "cavaliersarea";
