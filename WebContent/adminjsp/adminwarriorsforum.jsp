...
<body>
	...
	<div name="deletenote">
		<h3 align="left">勇士专区帖子管理：</h3>
		<form action="WarriorsNoteDeleteServlet" method="post">
			勇士专区帖子管理：<input type="text" name="postid"> <input
	...
	<table border="1" class="table4news" width="80%" align="center">
		...
		<%
			try {
				...
				String sql = "select postid,title,author,date from warriorsarea";
