...
<body>
	...
	<div name="deletenote">
		<h3 align="left">骑士专区帖子管理：</h3>
		<form action="CavaliersNoteDeleteServlet" method="post">
			骑士专区帖子管理：<input type="text" name="postid"> <input
	...
	<table border="1" class="table4news" width="80%" align="center">
		...
		<%
			try {
				...
				String sql = "select postid,title,author,date from cavaliersarea";
